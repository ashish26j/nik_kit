...
| **P1** | `TEST_P1_T01` sections in order · `T02` UNAVAILABLE shown/HIDDEN excluded · `T03` savoury customization embedded · `T04` sweets have none · `T05` store status open · `T06` unknown recipe 404 · `T07` admin reachable · `T08` included default accompaniments (pickle/chutney) · `T09` Raita (+40) add-on · `T10` media gallery (images + video link) · `T11` thumbnail = first image / none without media |
